                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-sm-4 position-relative bg-secondary bg-position-center bg-repeat-0 bg-size-contain" 
                                        style="background-image: url('<?php 
                                            ...
                                            echo $thumbnail_url ? esc_url($thumbnail_url) : get_template_directory_uri() . '/assets/img/image-placeholder-2.webp';
                                        ?>'); min-height: 15rem;">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                $category_link = !empty($categories) ? get_category_link($categories[0]->term_id) : get_category_link(1); // term_id 1 is Uncategorized
                                                ?>
